...
| `--image-description`          | -     | `boolean` | `false`                                      | Generate image descriptions in Java mode using a vision model API                                                                  |
| `--image-description-url`      | -     | `string`  | `"https://api.hamonize.com/ollama/api/chat"` | Image description API URL. Default: https://api.hamonize.com/ollama/api/chat                                                       |
| `--image-description-model`    | -     | `string`  | `"airun-vision:latest"`                      | Image description model name. Default: airun-vision:latest                                                                         |
| `--image-description-prompt`   | -     | `string`  | -                                            | Custom prompt for image description                                                                                                |
| `--image-description-language` | -     | `string`  | `"ko"`                                       | Language for generated image descriptions. Default: ko                                                                             |
| `--image-description-timeout`  | -     | `string`  | `"30000"`                                    | Image description request timeout in milliseconds. Default: 30000                                                                  |
| `--image-description-insecure` | -     | `boolean` | `false`                                      | Disable TLS certificate verification for image description API requests (use only with trusted servers)                            |

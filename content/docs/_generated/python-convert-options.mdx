...
| `image_description`          | `bool`               | `False`                                      | Generate image descriptions in Java mode using a vision model API                                                                  |
| `image_description_url`      | `str`                | `"https://api.hamonize.com/ollama/api/chat"` | Image description API URL. Default: https://api.hamonize.com/ollama/api/chat                                                       |
| `image_description_model`    | `str`                | `"airun-vision:latest"`                      | Image description model name. Default: airun-vision:latest                                                                         |
| `image_description_prompt`   | `str`                | -                                            | Custom prompt for image description                                                                                                |
| `image_description_language` | `str`                | `"ko"`                                       | Language for generated image descriptions. Default: ko                                                                             |
| `image_description_timeout`  | `str`                | `"30000"`                                    | Image description request timeout in milliseconds. Default: 30000                                                                  |
| `image_description_insecure` | `bool`               | `False`                                      | Disable TLS certificate verification for image description API requests (use only with trusted servers)                            |

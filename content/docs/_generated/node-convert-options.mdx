...
| `imageDescription`         | `boolean`            | `false`                                      | Generate image descriptions in Java mode using a vision model API                                                                  |
| `imageDescriptionUrl`      | `string`             | `"https://api.hamonize.com/ollama/api/chat"` | Image description API URL. Default: https://api.hamonize.com/ollama/api/chat                                                       |
| `imageDescriptionModel`    | `string`             | `"airun-vision:latest"`                      | Image description model name. Default: airun-vision:latest                                                                         |
| `imageDescriptionPrompt`   | `string`             | -                                            | Custom prompt for image description                                                                                                |
| `imageDescriptionLanguage` | `string`             | `"ko"`                                       | Language for generated image descriptions. Default: ko                                                                             |
| `imageDescriptionTimeout`  | `string`             | `"30000"`                                    | Image description request timeout in milliseconds. Default: 30000                                                                  |
| `imageDescriptionInsecure` | `boolean`            | `false`                                      | Disable TLS certificate verification for image description API requests (use only with trusted servers)                            |
